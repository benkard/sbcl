...
(declaim (type (member :compile #!+sb-eval :interpret #!+sb-eval :minimally-compile)
               *evaluator-mode*))
...
to :INTERPRET, an interpreter will be used. If set
to :MINIMALLY-COMPILE, a lightweight, non-native-code compiler will be
used.")
